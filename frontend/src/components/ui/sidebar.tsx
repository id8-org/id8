...
import { LayoutDashboard, Trello, User, Book } from 'lucide-react';
...
>(
  (
    ...
    // Split icon and label for layout control
    const icon = React.Children.toArray(children)[0]
    const label = React.Children.toArray(children).slice(1)
...
const SidebarNavigation: React.FC = () => {
  ...
  return (
    <SidebarMenu>
      ...
      <SidebarMenuItem>
        <Link to="/kanban">
          <SidebarMenuButton isActive={location.pathname === '/kanban'}>
            <Trello />
            Kanban
          </SidebarMenuButton>
        </Link>
